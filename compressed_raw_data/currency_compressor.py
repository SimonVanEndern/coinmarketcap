...
from compressed_raw_data.currency_dto import CurrencyDTO
...
class CurrencyCompressor:
    def __init__(self, currency, last_time):
        ...
        self.additional_data_path = LocalData.EXTERNAL_PATH_ADDITIONAL_DATA

        self.compressed_only_raw_data_folder = os.path.join(LocalData.EXTERNAL_PATH_COMPRESSED_DATA,
                                                            LocalData.FOLDER_COMPRESSED_DATA_ONLY_RAW_DATA,
                                                            self.currency)

        self.compressed_with_additional_data_folder = os.path.join(LocalData.EXTERNAL_PATH_COMPRESSED_DATA,
